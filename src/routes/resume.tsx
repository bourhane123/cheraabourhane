...
export const Route = createFileRoute("/resume")({
  head: () => ({
    meta: [
      { title: "Resume — Cheraa Bourhane | Meta Ads Specialist" },
      { name: "description", content: "View or download Cheraa Bourhane's resume — performance marketer and Meta Ads specialist." },
      { property: "og:title", content: "Resume — Cheraa Bourhane" },
      { property: "og:description", content: "Resume of Cheraa Bourhane — Meta Ads & growth systems." },
    ],
  }),
  component: ResumePage,
});

const PDF_URL = "/cb-resume.pdf";
      ...
      <section className="pt-32 pb-12">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="font-mono text-xs uppercase tracking-[0.25em] text-muted-foreground">The Resume</span>
          </div>
          <div className="grid lg:grid-cols-12 gap-10 items-end">
            <h1 className="lg:col-span-8 font-display text-5xl sm:text-7xl lg:text-8xl leading-[0.95]">
              The <em className="gradient-text not-italic">resume</em>.
            </h1>
            <div className="lg:col-span-4 flex flex-wrap gap-3 lg:justify-end">
              <a
                href={PDF_URL}
                download="Cheraa-Bourhane-Resume.pdf"
          ...
          <p className="mt-8 max-w-2xl text-muted-foreground text-lg leading-relaxed">
            Experience, skills, and credentials at a glance. Browse below or download a copy.
          </p>
        </div>
      </section>
