      ...
      <section id="contact" className="py-28 border-t border-border/50 relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 lg:px-10 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <a href="https://www.linkedin.com/in/cheraa-bourhane-741a13364/" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="px-8 py-4 border border-border font-mono uppercase text-xs tracking-[0.2em] hover:border-gold hover:text-gold transition-colors inline-flex items-center gap-2">
            ...
            <a href="https://www.instagram.com/bourhane1/" target="_blank" rel="noreferrer" aria-label="Instagram" className="px-8 py-4 border border-border font-mono uppercase text-xs tracking-[0.2em] hover:border-gold hover:text-gold transition-colors inline-flex items-center gap-2">
