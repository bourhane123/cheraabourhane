        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-12 gap-12 items-center w-full">
          <div className="lg:col-span-7 animate-float-up">
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              ...
              <a href="https://wa.me/213659201481" target="_blank" rel="noreferrer" className="px-6 py-3 border border-border text-sm font-mono uppercase tracking-[0.2em] hover:border-gold hover:text-[...]
                WhatsApp
              </a>
            </div>
      ...
      <section id="contact" className="py-28 border-t border-border/50 relative overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 lg:px-10 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a href="https://wa.me/213659201481" target="_blank" rel="noreferrer" className="px-8 py-4 bg-gold text-ink font-mono uppercase text-xs tracking-[0.2em] hover:bg-gold-soft transition-color[...]
            ...
            <a href="https://www.linkedin.com/in/cheraa-bourhane-741a13364/" target="_blank" rel="noreferrer" aria-label="LinkedIn" className="px-8 py-4 border border-border font-mono uppercase text-x[...]
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M20.5 2h-17A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h17a1.5 1.5 0 001.5-1.5v-17A1.5 1.5 0 0020.5 2zM8 19H5v-9h[...]
              LinkedIn
            </a>
            <a href="https://www.instagram.com/bourhane1/" target="_blank" rel="noreferrer" aria-label="Instagram" className="px-8 py-4 border border-border font-mono uppercase text-xs tracking-[0.2em[...]
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle [...]
              Instagram
            </a>
          </div>
